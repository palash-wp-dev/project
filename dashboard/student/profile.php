<?php 
  ...
  if(isset($_POST['profileSubmit']) && $_SERVER['REQUEST_METHOD'] == "POST"){
      ...
      if(empty($batch)){
        $errNotice[] = "<span class='alert alert-danger alert-dismissible' role='alert'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>Batch can't be empty.</span>";
      }
      elseif(empty($phone)){
                  ...
                  <form class="form-horizontal" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'])?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        ...
                        <input type="number" name="batch" class="form-control" placeholder="Enter Batch No">
